...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient/f:identifier">
      ...
      <sch:assert test="count(f:extension[@url = 'http://openhie.org/fhir/botswana-training/StructureDefinition/omang-id']) &gt;= 1">extension with URL = 'http://openhie.org/fhir/botswana-training/StructureDefinition/omang-id': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://openhie.org/fhir/botswana-training/StructureDefinition/omang-id']) &lt;= 1">extension with URL = 'http://openhie.org/fhir/botswana-training/StructureDefinition/omang-id': maximum cardinality of 'extension' is 1</sch:assert>
